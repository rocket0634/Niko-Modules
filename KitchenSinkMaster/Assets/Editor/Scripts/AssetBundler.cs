...
public class AssetBundler
{
    ...
    /// </summary>
    static List<string> EXCLUDED_ASSEMBLIES = new List<string> { "KMFramework.dll", "Newtonsoft.Json.dll", "0Harmony.dll", "Camera.dll", "Google.ProtocolBuffers.dll", "I18N.dll", "I18N.West.dll", "log4net.dll", "PdfSharp.dll", "SonyNP.dll", "Forwarder.dll" };
